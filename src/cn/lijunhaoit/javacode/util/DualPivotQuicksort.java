...
/**
 * 排序算法，名叫双轴排序算法，但实际运用了很多种算法混合，主要结合了空间使用率的一种
 * 依照数组长度来排序 计数排序 > 插入排序 > 快速排序 > 合并排序
 */
public class DualPivotQuicksort {
    ...
    /**
     * 如果要排序的数组长度小于此常量，则优先使用快速排序来合并排序。
     */
    private static final int QUICKSORT_THRESHOLD = 286;

    /**
     * 如果要排序的数组长度小于此常量，则插入排序优先于快速排序。
     */
    ...
    /**
     * 如果要排序的短数组或字符数组的长度大于此常量，则优先使用计数排序而不是快速排序。
     */
